    ...
    <div class="container mt-3 px-3 content-container">
        <div class="card card-custom border border-dark border-3">
            ...
            <div class="card-body">
                    ...
                    <?php if (!empty($cart_items)) : ?>
                        <?php $no = 1; foreach ($cart_items as $item) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('Kasir/hapus_item_cart/' . $item['rowid']); ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i> Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
                ...
                <a href="<?= site_url('Kasir/index'); ?>" class="btn btn-primary"><i class="bi bi-bag-plus"></i> Tambah Pesanan</a>
                <a href="<?= site_url('Kasir/checkout'); ?>" class="btn btn-success"><i class="bi bi-cart4"></i> Checkout</a>
            </div>
        </div>
    </div>
</div>
