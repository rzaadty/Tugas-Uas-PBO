  ...
  <div class="background-container">
    ...
    <div class="d-flex justify-content-between bg-secondary align-items-center px-3 py-2">
      <h4 class="text-uppercase text-dark">
        <i class="bi bi-wifi" style="font-size: 30px;"></i>
        Booking Online
      </h4>
            ...
            <a href="#" class="text-decoration-none">
              <div class="card shadow-sm border border-dark border-3">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= site_url('Booking/status_baru')?>" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i> Lihat Detail</a>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="#" class="text-decoration-none">
              <div class="card shadow-sm border border-dark border-3">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= site_url('Booking/status_diproses')?>" class="btn btn-warning btn-sm"><i class="bi bi-eye"></i> Lihat Detail</a>
                </div>
              </div>
            </a>
          </div>
            ...
            <a href="#" class="text-decoration-none">
              <div class="card shadow-sm border border-dark border-3">
                ...
                <div class="card-body">
                  ...
                  <a href="<?= site_url('Booking/status_selesai')?>" class="btn btn-success btn-sm"><i class="bi bi-eye"></i> Lihat Detail</a>
                </div>
              </div>
            </a>
          </div>
