          ...
          <a href="#" class="text-decoration-none">
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body">
                ...
                <a href="<?= site_url('Booking/status_baru')?>" class="btn btn-primary btn-sm">Lihat Detail</a>
              </div>
            </div>
          </a>
        </div>
          ...
          <a href="#" class="text-decoration-none">
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body">
                ...
                <a href="<?= site_url('Booking/status_diproses')?>" class="btn btn-warning btn-sm">Lihat Detail</a>
              </div>
            </div>
          </a>
        </div>
          ...
          <a href="#" class="text-decoration-none">
            <div class="card shadow-sm border-0">
              ...
              <div class="card-body">
                ...
                <a href="<?= site_url('Booking/status_selesai')?>" class="btn btn-success btn-sm">Lihat Detail</a>
              </div>
            </div>
          </a>
        </div>
