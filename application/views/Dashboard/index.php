<div class="container py-3 bg-secondary" style="display: flex; align-items: center;">
	<img src="<?= base_url('path/gambar_tampilan/logo.png')?>" alt="Logo"
		style="width: 60px; height: 40px; margin-right: 10px;">
	<h3 class=" text-dark">Home <br>Restaurantku</h3><br>
</div>
...
<div class="container text-center py-3 px-4">
	<h1 class="mb-3">
		<img src="<?= base_url('path/gambar_tampilan/logo.png')?>" alt="Logo" style="width: 120px; height: 80px;">
	</h1>
	<h2 class="mb-3">Welcome Mobile App <br> Restaurantku</h2>

	<div class="row justify-content-center">
		<div class="col-12 mb-4">
			<h3>
				<span class="badge rounded-pill bg-secondary text-white border border-dark border-4">MENU FITUR</span>
			</h3>
		</div>
