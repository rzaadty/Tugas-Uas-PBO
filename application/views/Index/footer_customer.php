...
<script src="<?php echo base_url('path/dist/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js'); ?>">
</script>
<script src="<?php echo base_url('path/dist/assets/compiled/js/app.js'); ?>"></script>
<script src="<?php echo base_url('path/dist/assets/extensions/simple-datatables/umd/simple-datatables.js'); ?>">
</script>
