...
<div class="background-container">
	...
	<div class=" d-flex justify-content-between bg-secondary align-items-center  px-3 py-2 ">
		<h4 class="text-uppercase text-dark">
			<i class="bi bi-broadcast" style="font-size: 30px;"></i>
			Reservasi Online
		</h4>
	...
	<div class="container mt-3 px-3">
		<div class="card shadow-sm border border-dark border-3">
			...
			<div class="card-body">
				<table class="table table-striped table-bordered" id="table1">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $item['stok']; ?></td>
							<td>
								<form action="<?= site_url('Customer_booking/tambah_ke_cart'); ?>" method="post"
				...
				<a href="<?= site_url('Customer_booking/lihat_cart')?>" class="btn btn-primary float-end"><i class="bi bi-eye"></i>
					Lihat Pesanan</a>
